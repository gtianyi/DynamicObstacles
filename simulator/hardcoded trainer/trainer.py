...
class Grid:
    ...
    def addObstacles(self):
        ...
        self.staticObstacles.append(StaticObstacle(7, 3))
        self.staticObstacles.append(StaticObstacle(4, 8))
        self.staticObstacles.append(StaticObstacle(3, 6))
        self.dynamicObstacles.append(DynamicObstacle(3, 2))
        self.dynamicObstacles.append(DynamicObstacle(4, 4))
        self.dynamicObstacles.append(DynamicObstacle(6, 5))
        self.dynamicObstacles.append(DynamicObstacle(7, 8))
        self.dynamicObstacles.append(DynamicObstacle(1, 6))
